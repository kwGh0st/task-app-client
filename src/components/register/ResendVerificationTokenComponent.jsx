...
import { executeResendVerificationToken } from "../../api/RegisterApiService";
import { ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

const ResendVerificationTokenComponent = () => {
  ...
  async function handleResendToken() {
    ...
    await executeResendVerificationToken(email)
      .then((response) => {
...
export default ResendVerificationTokenComponent;
