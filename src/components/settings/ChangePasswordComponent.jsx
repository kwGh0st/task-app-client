...
import { executeChangePassword } from "../../api/UserApiService";
...
const ChangePasswordComponent = () => {
  ...
  const updateAllFieldsValid = () => {
    setAllFieldsValid(
      validPassword && confirmPassword === newPassword && newPassword !== ""
    );
  };
  ...
  const handleConfirmPasswordChange = (e) => {
    ...
    setShowErrorPasswordMessage(newPassword !== newConfirmPassword);
  };
